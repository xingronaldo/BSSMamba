...
class Options():
    ...
    def init(self):
        ...
        self.parser.add_argument('--name', type=str, default='SECOND')
        ...
        self.parser.add_argument('--fpn_name', type=str, default='fpn')
        self.parser.add_argument('--channels', type=int, default=128)
        self.parser.add_argument('--encoder_depth', type=int, default=2)
        self.parser.add_argument('--decoder_depth', type=int, default=2)
        self.parser.add_argument('--neigh_size', type=int, default=5)
        ...
        self.parser.add_argument('--gamma', type=float, default=4)
        self.parser.add_argument('--margin', type=float, default=0.5)
        self.parser.add_argument('--dilation_ratio', type=float, default=0.0075)
